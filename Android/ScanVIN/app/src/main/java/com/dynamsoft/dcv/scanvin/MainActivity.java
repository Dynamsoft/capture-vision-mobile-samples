...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        router.addResultReceiver(new CapturedResultReceiver() {
            ...
            public void onParsedResultsReceived(@NonNull ParsedResult result) {
                if (result.getItems().length > 0) {
                    VINData vinData = VINData.fromParsedItem(result.getItems()[0]);
                    if (vinData == null) {
                        showParsedText();
                    } else {
                        goToResultActivity(vinData);
    ...
    public void onResume() {
        ...
        router.startCapturing(currentTemplate, new CompletionListener() {
            ...
            public void onSuccess() {
                // Enable the mode switch radio group after startCapturing successfully.
                findViewById(R.id.rg_modes).setEnabled(true);
            }
    ...
    private void initSwitchModeRadioGroup() {
        RadioGroup rgModels = findViewById(R.id.rg_modes);
        ...
        rgModels.setOnCheckedChangeListener((group, checkedId) -> {
            Log.e("TAG", "initSwitchModeRadioGroup: "+checkedId+" "+rgModels.isEnabled());
        ...
        // Prevent switching templates before the onSuccess callback of startCapturing is triggered;
        // otherwise, the switched template will not take effect.
        rgModels.setEnabled(false);
    }
    ...
    private void goToResultActivity(@NonNull VINData vinData) {
        Intent intent = new Intent(this, ResultActivity.class);
        intent.putExtra("vinData", vinData);
